  ...
  return (
    <>
      <button
        ...
        className="flex items-center gap-2 px-3.5 py-2 rounded-xl text-xs sm:text-sm font-semibold text-slate-700 dark:text-slate-200 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 border border-slate-200/80 dark:border-slate-700/60 shadow-xs transition-colors"
      >
          ...
          <div className="relative w-full max-w-lg bg-white dark:bg-slate-900 rounded-3xl border border-slate-200/90 dark:border-slate-800/90 shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
            ...
            <div className="overflow-y-auto p-6 sm:p-8 space-y-5">
              ...
              <div className="flex items-start gap-3.5 pr-8">
                <div className="w-11 h-11 rounded-2xl bg-emerald-500/10 dark:bg-emerald-500/20 text-emerald-600 dark:text-emerald-400 border border-emerald-500/20 flex items-center justify-center shrink-0">
              ...
              <div className="flex items-center justify-between gap-3 p-3.5 rounded-2xl bg-emerald-50/70 dark:bg-emerald-950/30 border border-emerald-200/80 dark:border-emerald-900/60">
                <div className="flex items-center gap-2.5 min-w-0">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-[11px] text-emerald-700/90 dark:text-emerald-400/80 truncate">
                ...
                <button
                  ...
                  className="shrink-0 flex items-center gap-1.5 px-3 py-1.5 rounded-xl font-bold text-xs text-white bg-emerald-600 hover:bg-emerald-700 active:scale-95 shadow-sm shadow-emerald-600/20 transition-all disabled:opacity-60"
                >
                  {downloadingTemplate ? (
                  ...
                  <span>{downloadingTemplate ? 'Downloading...' : 'Template'}</span>
                </button>
              </div>
              ...
              <form onSubmit={handleUpload} className="space-y-5">
                ...
                <div className="p-3.5 rounded-2xl bg-slate-50 dark:bg-slate-950/50 border border-slate-200/80 dark:border-slate-800 text-[11px] space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-slate-500 dark:text-slate-400">
                    <div className="flex items-center gap-1.5">
                      ...
                      <span><strong className="text-slate-700 dark:text-slate-300">Name</strong> (Full Name)</span>
                    </div>
                    <div className="flex items-center gap-1.5">
                      <span className="w-1.5 h-1.5 rounded-full bg-emerald-500" />
                      <span><strong className="text-slate-700 dark:text-slate-300">College</strong> (Code)</span>
                    </div>
                    <div className="flex items-center gap-1.5">
                      <span className="w-1.5 h-1.5 rounded-full bg-slate-400" />
                      <span>Department <span className="text-[10px] opacity-70">(optional)</span></span>
                    </div>
                    <div className="flex items-center gap-1.5">
                      <span className="w-1.5 h-1.5 rounded-full bg-slate-400" />
                ...
                <div className="flex items-center justify-end gap-3 pt-2 border-t border-slate-100 dark:border-slate-800/80">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs sm:text-sm font-bold text-white bg-bisu-blue-700 hover:bg-bisu-blue-800 shadow-md shadow-bisu-blue/20 active:scale-95 transition-all disabled:opacity-50 disabled:shadow-none"
                  >
                    {uploading ? (
                    ...
                    <span>{uploading ? 'Importing Roster...' : 'Upload & Import'}</span>
                  </button>
                </div>
              </form>
            </div>
