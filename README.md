...
- **Backend API URL**: [https://td-server-6azz.onrender.com](https://td-server-6azz.onrender.com)
...
```env
VITE_API_BASE_URL=https://td-server-6azz.onrender.com
```
...
- **Live Backend API**: [td-server-6azz.onrender.com](https://td-server-6azz.onrender.com)
